  ...
  const messages: PopupMessage[] = [
    {
      ...
      text: <span className="text-white/90">Hanya memikirkan senyum manismu...</span>,
      delay: 2000,
      duration: 5000,
    },
    {
      ...
      text: <span className="text-white/90">Kamu adalah orang paling luar biasa dalam hidupku.</span>,
      delay: 4500,
      duration: 6000,
    },
    {
      id: 3,
      icon: <Heart className="w-4 h-4 text-rose-400" />,
      text: <span className="text-white/90">Setiap saat bersamamu terasa seperti keajaiban. ✨</span>,
      delay: 8000,
      duration: 7000,
    },
    {
      ...
      text: <span className="text-white/90">Aku mencintaimu lebih dari yang bisa dikatakan kata-kata.</span>,
      delay: 12000,
      duration: 7000,
    },
    {
      id: 5,
      icon: <Heart className="w-4 h-4 text-purple-400" />,
      text: <span className="text-white/90">Kamu adalah hari iniku dan seluruh hari esokku. ❤️</span>,
      delay: 16000,
      duration: 8000,
    },
    {
      id: 6,
      icon: <Heart className="w-4 h-4 text-rose-400" />,
      text: <span className="text-white/90">Selalu milikmu, sepenuhnya jatuh cinta.</span>,
      delay: 21000,
      duration: 8000,
    }
  ];
